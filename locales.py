...
TEXTS.update({
    ...
    "order_created_ok":{"ua":"✅ Замовлення #{id} прийнято.\\nМи скоро з вами зв'яжемося ❤️","ru":"✅ Заказ #{id} принят.\\nМы скоро с вами свяжемся ❤️","pl":"✅ Zamówienie #{id} zostało przyjęte.\\nWkrótce się skontaktujemy ❤️","en":"✅ Order #{id} has been accepted.\\nWe will contact you soon ❤️"},
